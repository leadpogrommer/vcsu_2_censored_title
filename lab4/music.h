...
// https://github.com/tsukisan/Arduino/blob/master/WiiClassicSoundboard/WiiClassicSoundboard.ino
...
const int music_death[] = {17,                                                  // Array for Death sound effect & song
